...
<body style="margin-bottom:22px">
    ...
    <div class="grid">
        <div class="element1">
            <h1 style=" color:#313060">Lista de reproduccion seleccionada</h1>
            <div id="main-container">
                <table>
                    <thead>
                        <tr>
                            <th scope="col">ID</th>
                            <th scope="col">Nombre Lista de reproduccion</th>
                            <th scope="col">Duracion</th>
                            <th scope="col">Cantidad de canciones</th>
                            <th scope="col">Descripcion</th>
                            <th scope="col">Fecha de creacion</th>
                            <th scope="col">ID Usuario creador</th>
                        </tr>
                    </thead>
                    <tr>
                        <td>{{$playlist->id}}</td>
