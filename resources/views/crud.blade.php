    ...
    <div class="container">
      ...
      <div class="col-3 d-flex justify-content-center">
          <div class="card" style="width: 18rem;">
            ...
            <div class="card-body">
              <a href="/crud/user_crud/user_index" class="btn btn-primary">Usuarios</a>
            </div>
          </div>
        </div>
        ...
        <div class="col-3 d-flex justify-content-center">
          <div class="card" style="width: 18rem;">
            <img src="https://cdn.pixabay.com/photo/2022/06/21/21/15/audio-7276511_960_720.jpg" class="card-img-top">
            <div class="card-body">
              <a href="/crud/song_crud/song_index" class="btn btn-primary">Canciones</a>
            </div>
          </div>
        </div>
        ...
        <div class="col-3 d-flex justify-content-center">
          <div class="card" style="width: 18rem;">
            <img src="https://cdn.pixabay.com/photo/2022/06/21/21/15/audio-7276511_960_720.jpg" class="card-img-top">
            <div class="card-body">
            <a href="/crud/location_crud/location_index" class="btn btn-primary">Ubicaciones</a>
            </div>
          </div>
        </div>
        ...
        <div class="col-3 d-flex justify-content-center">
          <div class="card" style="width: 18rem;">
            <img src="https://cdn.pixabay.com/photo/2022/06/21/21/15/audio-7276511_960_720.jpg" class="card-img-top">
            <div class="card-body">
            <a href="/crud/payment_method_crud/payment_method_index" class="btn btn-primary">Métodos de pago</a>
            </div>
          </div>
        </div>
        ...
        <div class="col-3 d-flex justify-content-center">
          <div class="card" style="width: 18rem;">
            <img src="https://cdn.pixabay.com/photo/2022/06/21/21/15/audio-7276511_960_720.jpg" class="card-img-top">
            <div class="card-body">
              <a href="/crud/playlist_crud/playlist_index" class="btn btn-primary">Listas de reproducción</a>
            </div>
          </div>
        </div>
        ...
        <div class="col-3 d-flex justify-content-center">
          <div class="card" style="width: 18rem;">
            <img src="https://cdn.pixabay.com/photo/2022/06/21/21/15/audio-7276511_960_720.jpg" class="card-img-top">
            <div class="card-body">
            <a href="/crud/rate_crud/rate_index" class="btn btn-primary">Valoraciones</a>
            </div>
          </div>
        </div>
        ...
        <div class="col-3 d-flex justify-content-center">
          <div class="card" style="width: 18rem;">
            <img src="https://cdn.pixabay.com/photo/2022/06/21/21/15/audio-7276511_960_720.jpg" class="card-img-top">
            <div class="card-body">
              <a href="/crud/song_genre_crud/song_genre_index" class="btn btn-primary">Genero Canción</a>
            </div>
          </div>
        </div>
        ...
        <div class="col-3 d-flex justify-content-center">
          <div class="card" style="width: 18rem;">
            <img src="https://cdn.pixabay.com/photo/2022/06/21/21/15/audio-7276511_960_720.jpg" class="card-img-top">
            <div class="card-body">
              <a href="/crud/follow_crud/follow_index" class="btn btn-primary">Follows</a>
            </div>
          </div>
        </div>
        ...
        <div class="col-3 d-flex justify-content-center">
          <div class="card" style="width: 18rem;">
            <img src="https://cdn.pixabay.com/photo/2022/06/21/21/15/audio-7276511_960_720.jpg" class="card-img-top">
            <div class="card-body">
              <a href="/crud/like_crud/like_index" class="btn btn-primary">Likes</a>
            </div>
          </div>
        </div>
