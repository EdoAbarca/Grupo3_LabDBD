...
Route::delete('/albums/delete/{id}','App\Http\Controllers\AlbumController@destroy');
...
Route::delete('/follows/delete/{id}','App\Http\Controllers\FollowController@destroy');
...
Route::delete('/genres/delete/{id}','App\Http\Controllers\GenreController@destroy');
...
Route::delete('/likes/delete/{id}','App\Http\Controllers\LikeController@destroy');
...
Route::delete('/locations/delete/{id}','App\Http\Controllers\LocationController@destroy');
...
Route::delete('/permissions/delete/{id}','App\Http\Controllers\PermissionController@destroy');
...
Route::delete('/playlists/delete/{id}','App\Http\Controllers\PlaylistController@destroy');
...
Route::delete('/rates/delete/{id}','App\Http\Controllers\RateController@destroy');
...
Route::delete('/role_permissions/delete/{id}','App\Http\Controllers\Role_permissionController@destroy');
...
Route::delete('/song_genres/delete/{id}','App\Http\Controllers\Song_genreController@destroy');
...
Route::delete('/songs/delete/{id}','App\Http\Controllers\SongController@destroy');
...
Route::delete('/users_role/delete/{id}','App\Http\Controllers\User_roleController@destroy');
